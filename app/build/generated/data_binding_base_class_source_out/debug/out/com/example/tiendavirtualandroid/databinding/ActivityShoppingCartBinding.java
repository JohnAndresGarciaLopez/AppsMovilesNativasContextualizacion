...
public final class ActivityShoppingCartBinding implements ViewBinding {
  ...
  private ActivityShoppingCartBinding(@NonNull CoordinatorLayout rootView,
      @NonNull RecyclerView shoppingCartRecycle) {
    this.rootView = rootView;
    this.shoppingCartRecycle = shoppingCartRecycle;
  }
  ...
  public static ActivityShoppingCartBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.shopping_cart_recycle;
      RecyclerView shoppingCartRecycle = ViewBindings.findChildViewById(rootView, id);
      if (shoppingCartRecycle == null) {
        break missingId;
      }

      return new ActivityShoppingCartBinding((CoordinatorLayout) rootView, shoppingCartRecycle);
    }
