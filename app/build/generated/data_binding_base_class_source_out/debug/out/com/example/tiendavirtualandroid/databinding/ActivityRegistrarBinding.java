...
public final class ActivityRegistrarBinding implements ViewBinding {
  ...
  private ActivityRegistrarBinding(@NonNull LinearLayout rootView, @NonNull EditText email,
      @NonNull Button loginButton, @NonNull EditText password, @NonNull EditText username) {
  ...
  public static ActivityRegistrarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegistrarBinding((LinearLayout) rootView, email, loginButton, password,
          username);
    }
